...
$(document).ready(function () {
    ...
    if($("#user-nickname").text()!=sessionStorage.getItem('nickname')) {
        $("#user-nickname").html(sessionStorage.getItem('nickname') + "&nbsp;<span class='caret'></span>");
    }

    if($("#admin-nickname").text()!=sessionStorage.getItem('nickname')) {
        $("#admin-nickname").html(sessionStorage.getItem('nickname'));
    }
    ...
    document.addEventListener("error", function (e) {
        ...
        if (elem.tagName.toLowerCase() == 'img') {
            elem.src = "/images/linkFailed.jpg";
        }
    }, true);
